...
function LoginForm() {
  return (
    <>
      <div className="flex justify-center items-center h-screen transform transition-transform(translate-y-4)">
        <div className="flex-wrap hidden lg:block">
        ...
        <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
